...
```bash
GET /authorize?response_type=code&client_id=abc123&client_secret=abc&state=test&scope=userinfo&redirect_uri=https%3a%2f%2fclient.com%2findex HTTP/1.1
Host: demo.com
```
...
grant_type=authorization_code&code=1234****abcd&redirect_uri=https%3a%2f%2fclient.com%2findex HTTP/1.1
```
