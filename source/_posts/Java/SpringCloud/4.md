...
![简单的微服务系统](router_architecture.png)
...
添加注解 `@EnableZuulProxy` 开启 Zuul 功能（即其本身也要向 Server 中心注册）：
...
# 以 /api-a/ 开头的请求都转发给 consumer-ribbon 服务
zuul.routes.api-a.path=/api-a/**
zuul.routes.api-a.service-id=consumer-ribbon
# 以 /api-b/ 开头的请求都转发给 consumer-feign 服务
